...
La idea de este apartado es que utilicen las funciones **group_by()** y la función de resumen **summarise()**
<!-- , donde la estructura del código debería ser: -->
